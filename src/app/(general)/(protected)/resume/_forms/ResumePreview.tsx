...
export function ResumePreview() {
  ...
  const Template = templates[debounceData.template ?? "Classic"];
  // const Template = templatesPDF[debounceData.template ?? "Classic"];
  ...
  return (
    <div className="bg-gray-300 relative">
      <div className="flex items-center sticky top-0 bg-gray-300 lg:w-[213mm] mx-auto py-3 pl-[1.5mm] gap-2 z-10">
        <AccentColorPicker />
        <ResumeSave />
        <TemplateSwitcher />
      </div>
